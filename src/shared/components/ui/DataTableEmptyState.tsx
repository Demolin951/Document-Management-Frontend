import type { DataTableEmptyStateProps } from "./types/dataTableEmptyStateTypes";

function DataTableEmptyState({ icon: Icon, title, description }: DataTableEmptyStateProps) {
  return (
